...
Public Sub UpdateTo(ByVal Current As Long, ByVal Max As Long, _
                    Optional ByVal ShowAsPercentage = True)
...
Public Property Let Cancellable(Value As Boolean)
